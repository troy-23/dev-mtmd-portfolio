...
const projectsData = [
  {
    ...
    description: "Responsive music library built with Redis/KV-backed song metadata and view tracking, custom admin tools, secure server-side authentication, media fallback protection, audio/video playback, and production security hardening.",
  ...
  },
  {
    id: "2",
    title: "Kensei",
    description: "Modern product mockup exploring clean UI, refined typography, and immersive product storytelling, built end-to-end with AI-assisted design and development workflows.",
  ...
  },
  {
    id: "3",
    title: "Hireyert",
    description: "Hiring and recruiting web app built with a modern Next.js stack, reusable Radix UI components, form flows, charts, animation, and Vercel deployment.",
  ...
  },
  {
    id: "4",
    title: "Kaelveyra",
    description: "Analytics-focused Next.js experience using React 19, TypeScript, Tailwind CSS 4, motion, charts, icons, and shadcn-style component patterns.",
  ...
  },
  {
    id: "5",
    title: "YortyCollects",
    description: "E-commerce platform for a collectibles business, combining storefront structure, product presentation, and AI-assisted content direction.",
  ...
  },
  {
    id: "6",
    title: "Hypertroyphy",
    description: "Health and fitness education platform with workouts, nutrition content, and personalized tracking concepts for user-focused learning.",
  ...
  },
  {
    ...
    description: "Professional GPU repair shop landing page with service-focused copy, responsive sections, GSAP ScrollTrigger animations, and production deployment.",
  ...
  },
  {
    ...
    description: "Modern landing page for a 2K26 pilot service platform with clean UI, clear offer positioning, and fast Vercel deployment.",
